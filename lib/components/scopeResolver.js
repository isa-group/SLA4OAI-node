...
ScopeResolver.prototype.configure = function (options) {
  options = options || {};
  this._defaultOAuthProvider = options.defaultOAuthProvider;
 ...
 * @api public
 */
ScopeResolver.prototype.getAccountName = function (oauthProvider, token, callback) {
...
/**
 * Function that set `agreement`, `scope`, and `requestedMetrics` in `req.sla` .
 *
 * @param {string} paramName
 * @param {string} paramValue
 * @param {object} req
