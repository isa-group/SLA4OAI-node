...
var Sla4oaiUIredirect = require('./components/sla4oaiUIredirect');
...
var sla4oaiUIredirect = new Sla4oaiUIredirect();
...
SlaManager.prototype.sla4oaiUIredirect = sla4oaiUIredirect;
 ...
 * @api public
 */
SlaManager.prototype.register = function (app, supervisorConnection, monitorConnection, sla4oaiUIredirectOptions) {
    if (!app) {
    ...
    if(sla4oaiUIredirectOptions){
        sla4oaiUIredirect.init(app, sla4oaiUIredirectOptions);
    }
